    ...
    <v-card class="transparent mx-auto" flat light tile>
      <div class="mb-4">
        <v-card class="info-screen border-3" flat light tile>
          <v-card-text class="pb-6 special-pt-on-mobile">
            <div class="my-1 mt-4">
              <v-btn
              ...
              <div
                class="mt-4 v-card__text pa-0 text-body-1 font-weight-medium"
              >
  ...
  methods: {
    finishSurveyHandler() {
      ...
      this.questions.forEach((_, qIndex) => {
        this.questions[qIndex].hasError =
          this.questions[qIndex].value !== this.questions[qIndex].correctValue;
      });
